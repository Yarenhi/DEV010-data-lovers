export default {
  "breaking_bad": [
    ...
    },
    {
      ...
      img: "https://s.yimg.com/ny/api/res/1.2/mVyC6kbm7iGrePi7BOPAow--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTEyODA-/https://s.yimg.com/uu/api/res/1.2/f7s7FHSvjjPj1MSzG2NKSA--~B/aD0yMDQ4O3c9MTUzNjthcHBpZD15dGFjaHlvbg--/http://l.yimg.com/os/423/2013/08/06/BBS5B-Gallery-0182-RGB-V1-jpg_202021.jpg",
      status: "Deceased",
      nickname: "Lydia",
      appearance: [5],
    ...
    },
    {
      ...
      birthday: "Unknown",
      occupation: ["Infant"],
      img: "https://i.pinimg.com/originals/26/c0/47/26c0474cec026f0f059a410d6bf118d8.png",
      status: "Alive",
      nickname: "Holly",
      appearance: [2, 3, 4, 5],
      portrayed: "Unknown",
